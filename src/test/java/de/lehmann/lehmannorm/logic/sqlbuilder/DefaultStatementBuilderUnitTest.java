...
public class DefaultStatementBuilderUnitTest extends AConnectionTest
{
  ...
  public static Object[][] parameters()
  {
    ...
    return new Object[][] {
        { insertStatementBuilder, "INSERT INTO TEST_ENTITY_A(ID,NUMBER,DESCRIPTION) VALUES(?,?,?);" },
        { selectStatementBuilder, "SELECT ID,NUMBER,DESCRIPTION FROM TEST_ENTITY_A WHERE ID=?;" }
    };
  }
  ...
  private static class TestEntityA extends AbstractEntity<Integer>
  {
    ...
    public final static EntityToOneColumnInfo<Integer> ID =
        new EntityToOneColumnInfo<>("ID", Integer.class);
    /*
     * The next value hasn't a column name because the
     * foreign key is stored by the referenced entity.
     */
    public final static EntityToOneColumnInfo<TestEntityB> REF_ID      =
        new EntityToOneColumnInfo<>(TestEntityB.class);
    public final static EntityToOneColumnInfo<Double>      NUMBER      =
        new EntityToOneColumnInfo<>("NUMBER", Double.class);
