 ...
 *
 * @param <ECIT>
 *          This is the type that is delegated to the {@link EntityColumnInfo}.
 *          It should be the same as ECVT. For some generic cases it makes
 *          sense to ignore the strong bound and handle these types separately.
 * @param <ECVT>
